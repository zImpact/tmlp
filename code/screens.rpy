init python: 
    ...
    if persistent.tmlp_part_one_achievements == None:
        persistent.tmlp_part_one_achievements = {
                "tl1": False,
                }

    if persistent.tmlp_part_two_achievements == None:
        persistent.tmlp_part_two_achievements = {
                "tl2": False,
                }

    if persistent.tmlp_part_three_achievements == None:
        persistent.tmlp_part_three_achievements = {
                "tl3": False,
                }

    tmlp_part_one_achievments = {
        "tl1": persistent.tmlp_part_one_achievements["tl1"]
    }

    tmlp_part_two_achievments = {
        "tl2": persistent.tmlp_part_two_achievements["tl2"]
    }

    tmlp_part_three_achievments = {
        "tl3": persistent.tmlp_part_three_achievements["tl3"]
    }
...
screen tmlp_main_menu():
    ...
    textbutton ["Начать игру"]:
        ...
        text_align 0.5
        ypos 250
        action [Hide("tmlp_part_one_main_menu"), Start("tmlp_part_one_prologue_day_one")]
...
screen tmlp_part_one_extra_main_menu:
    tag menu
    modal True    
    ...
    textbutton ["Спрайты"]:
        ...
        text_align 0.5
        ypos 295
        action [Hide("tmlp_part_one_main_menu"), ShowMenu("tmlp_load")]
    ...
    textbutton ["Фоны"]:
        ...
        text_align 0.5
        ypos 463
        action [Hide("tmlp_part_one_extra_main_menu"), ShowMenu("tmlp_part_one_gallery")]
    ...
    textbutton ["Музыка"]:
        ...
        text_align 0.5
        ypos 623
        ##action [Hide("tmlp_part_one_extra_main_menu"), (SetVariable("tmlp_page", 0), ShowMenu("tmlp_part_one_music_room"))]
        action [Hide("tmlp_part_one_extra_main_menu"), ShowMenu("tmlp_part_one_music_room")]
    ...
    textbutton ["Назад"]:
        ...
        xalign 0.1
        ypos 960
        action [Hide("tmlp_part_one_extra_main_menu"), ShowMenu("tmlp_part_one_main_menu")]

screen tmlp_part_one_quit_main_menu:
    tag menu
    modal True
    ...
    textbutton ["Нет"]:
        ...
        xalign 0.6
        yalign 0.6
        action [Hide("tmlp_part_one_quit_main_menu"), Return()]

screen tmlp_part_one_load_main_menu:
    tag menu
    modal True
        ...
        for i in range(1, 13):
            fixed:
                ...
                button:
                    ...
                    xfill False
                    yfill False
                    style "tmlp_save_load_button_main_menu_part_one"
                    fixed:
...
screen tmlp_part_one_preferences_main_menu:
    tag menu
    modal True
    ...
    textbutton ["В окне"]:
        style "tmlp_button_none"
        text_style "tmlp_text_small_preference_main_menu_part_one"
        xpos 770
        ypos 275
            
        if not _preferences.fullscreen:
            text_style "tmlp_text_small_invers_preference_main_menu_part_one"
    ...
    bar:
        ...
        left_bar tmlp_gui_path + "preferences/main_menu/bar_full.png"
        thumb tmlp_thumb
        xpos 1260
        ypos 280
        xmaximum 394
    ...
    textbutton ["Назад"]:
        ...
        xalign 0.1
        ypos 960
        action [Hide("tmlp_part_one_preferences_main_menu"), Return()]
